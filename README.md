...
<p align="center">
  ...
  💼 Desenvolvedora Fullstack (foco em Back-end) no <b>JOTA</b> <br>
...
```
Muito prazer! Sou a Alyne, Desenvolvedora Fullstack (com foco em Back-end) no JOTA.
- Construo e mantenho integrações em Django e APIs REST, trabalhando com AWS
(Lambda, SQS, SNS) e BigQuery, sempre com foco em testes automatizados e boas
práticas de engenharia.
- Atuo também em projetos de eficiência com IA, usando agentes e ferramentas como
GitHub Copilot, Claude, Gemini e GPT, além de escrever documentações técnicas
para dividir o conhecimento entre o time (e estudar WordPress e SEO pelo caminho).
- Antes do JOTA, adquiri experiência fullstack com PHP (Laravel Nova) e Vue.js,
somando mais de dois anos na área.
...
<p align="center">
	...
	<img src="https://www.svgrepo.com/show/448266/aws.svg" alt="AWS" height="40" style="vertical-align:top; margin:4px">
